  ...
  <div class="flex bg-orange-50 w-full">
    ...
    <main class="w-10/12 flex-1 bg-orange-50 p-8 mt-16">
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          />
                          <img
                            @click="showConfirmDialog(user.user_id)"
      ...
      <div v-if="showModal" class="fixed inset-0 z-50">
        ...
        ></div>
        <div
          class="top-32 relative pt-6 pb-8 px-6 mx-auto my-auto bg-white rounded-lg w-full h-full max-w-xl md:h-auto"
        >
          ...
          <div class="overflow-y-scroll h-[350px]">
            ...
            <div class="px-4">
              <div>
                <label for="user_name" class="block mb-2 text-sm font-medium"
                  >Name</label
                >
                <input
                  type="text"
