      ...
      <div class="mx-auto my-auto">
          ...
          <div class="px-6 py-8">
            ...
            <div class="flex justify-between items-start">
              <div class="w-1/2">
                ...
                <div class="my-2">
                  <p class="text-white text-sm text-opacity-75">
                    +62 346 7835 43
                  </p>
                  <p class="text-white text-sm text-opacity-75">
        ...
        <div class="bg-gray-100">
          ...
          <div class="flex justify-evenly items-start px-6 py-4">
            <div class="w-1/3">
              ...
              <p class="font-semibold">
                {{ this.orderDetail[0].customer_name }}
              </p>
          ...
          <div class="px-6 py-8">
            <p class="text-right">
              Total:
              <span class="font-bold text-xl">Rp{{ this.totalPrice }}</span>
            </p>
          </div>
        </div>
      </div>
